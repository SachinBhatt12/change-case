    ...
    <div className="container" id="whyUs">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 p-5 sm:p-20">
        <div className="w-full h-72 sm:h-auto">
          <img src={we_are_the_best} className="mx-auto h-full" alt="why we are the best" />
        </div>
          ...
          <div className="button pt-8">
            <NavLink to="/scraprates">
              <button
                ...
                className="px-44 py-2 border-2 border-blue-500 text-blue-500 hover:text-white hover:border-white hover:bg-blue-500 transition-all duration-700 transform translate-x-0 group-hover:translate-x-full"
              >
                Get Started
              </button>
            </NavLink>
