...
function WhyWeAreBest() {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-10 md:p-20">
    <div className="w-full md:w-587 h-540">
      <img src={we_are_the_best} className="w-full h-full" alt="why we are the best" />
    </div>
    <div className="flex flex-col justify-between">
      <div className="self-end md:self-auto">
        <img src={element} alt="star design image" />
      </div>
      <h1 className="text-center md:text-left text-2xl">Why we are the best</h1>
