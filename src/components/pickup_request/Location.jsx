  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-left">
        <div className="py-2">
          <label htmlFor="flat">Flat/House no./Apartment <span className='text-red-600'>*</span></label>
          <br />
        ...
        <div className="py-2">
          <label htmlFor="area">Area/Street/Sector/Village<span className='text-red-600'>*</span></label>
          <br />
        ...
        <div className="py-2">
          <label htmlFor="city">Town/City<span className='text-red-600'>*</span></label>
          <br />
