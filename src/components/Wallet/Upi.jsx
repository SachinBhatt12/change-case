                ...
                <div className="bg-white relative p-10 lg:w-1/3 md:w-1/3 w-full rounded-2xl m-48">
                    ...
                    <div>
                        ...
                        <input
                            type="email"
                            name="upiId"
                            className="inputCommonCss w-10/12 bg-white text-black text-center mt-4"
                    ...
                    <div className='mt-10'>
                        ...
                        <input
                            type="email"
                            name="upi"
                            className="inputCommonCss w-10/12 bg-white text-black text-center mt-4" value={inputAmount}
