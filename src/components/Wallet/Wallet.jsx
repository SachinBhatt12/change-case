              ...
              <div className='relative'>
                ...
                <div className='flex'>
                  <NavLink to='' onClick={() => handlePopupClick()}>
                    <button type='submit' className='mr-2 border-green-600 border-2 lg:px-10 md:px-6 sm:px-6 px-3 text-green-600 lg:py-1 md:py-3 sm:py-3 sm:py-2 font-medium rounded-xl text-sm lg:text-xl md:text-xl sm:text-lg'>
                      UPI
                    </button>
                  </NavLink>
                  <NavLink to='/transfertobank'>
                    <button type='submit' className='border-green-600 border-2 lg:px-10 md:px-6 sm:px-6 px-3 text-green-600 lg:py-1 md:py-3 sm:py-3 sm:py-2 font-medium rounded-xl text-sm lg:text-xl md:text-xl sm:text-lg'>
                      Bank
                    </button>
                  </NavLink>
                </div>
